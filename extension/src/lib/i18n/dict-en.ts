...
export const en: Dict = {
  ...
  'activity.dm-sync.run-ok': 'Sync OK — {inserted} new, {replied} replied.',
  'activity.dm-sync.run-fail': 'Sync failed: {reason}',
  'activity.chat-sync.run-ok': 'Chat sync OK — {messages} messages, {inserted} new.',
  'activity.chat-sync.unauthorized': 'Chat sync unauthorized — Matrix token expired.',
