...
For the **cloud edition** (`https://app.pitchbox.app/*`) the same script runs automatically the first time you visit while signed in, so cloud users never see the pairing button.
