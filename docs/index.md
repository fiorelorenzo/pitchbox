...
hero:
  name: Pitchbox
  text: Self-hosted outreach agent.
  tagline: An agent does the research and drafting. You stay in the loop and decide what gets sent.
  actions:
    - theme: brand
      text: Get started
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/fiorelorenzo/pitchbox
features:
