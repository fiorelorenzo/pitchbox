...
import { MAX_VOICE_SAMPLES, type PersonaExperience } from '@pitchbox/shared/assist/context';
...
export const actions: Actions = {
  ...
  // action only ever flips the `excluded` flag.
  toggleVoiceSample: async (event) => {
    ...
    return { toggledSampleId: sampleId };
  },
};
