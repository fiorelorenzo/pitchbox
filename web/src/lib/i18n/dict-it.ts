...
export const it = {
  ...
  'inbox.shortcuts-description': "Disponibili nell'inbox quando il focus non è su un campo di input.",
  ...
  'draft-list-item.measured-title': 'Misurata (controllo di stile + voce dell\'operatore, nessuna chiamata al modello)',
