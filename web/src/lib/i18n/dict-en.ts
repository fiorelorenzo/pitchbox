...
export const en = {
  ...
  'inbox.reschedule-dialog-body.one': 'Hold {n} draft back from "ready to send" until the chosen time.',
  'inbox.reschedule-dialog-body.other': 'Hold {n} drafts back from "ready to send" until the chosen time.',
