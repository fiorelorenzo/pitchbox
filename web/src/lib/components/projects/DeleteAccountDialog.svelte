  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
    <div class="bg-background border border-border rounded-lg p-6 w-full max-w-md pointer-events-auto space-y-4">
      ...
      <p class="text-sm text-muted-foreground">
        This permanently deletes the stored credentials for <code class="bg-muted px-1 rounded">{name}</code
        >. Campaigns using this account will no longer be able to post or reply as it. Type the
        account handle <code class="bg-muted px-1 rounded">{name}</code> to confirm.
      </p>
